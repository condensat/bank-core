...
func Test_currencyColumnNames(t *testing.T) {
	...
	fields := tests.GetSortedTypeFileds(reflect.TypeOf(model.Currency{}))
...
func TestCurrency(t *testing.T) {
	...
	db := tests.Setup(databaseName, CurrencyModel())
...
func checkFinalState(t *testing.T, db database.Context, entries []model.Currency) {
